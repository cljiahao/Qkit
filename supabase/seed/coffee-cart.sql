...
values (
  ...
  -- Fixed test-only short code (12 base62 chars) overriding the random
  -- gen_short_code() default, so e2e specs can navigate to /o/<code>
  -- deterministically. See e2e/order-code.spec.ts.
  'e2eKopitiam01',
  '[
    {
