...
CREATE OR REPLACE FUNCTION qkit.set_license_label(
  p_license_id UUID,
  p_label      TEXT
)
RETURNS VOID
...
REVOKE ALL ON FUNCTION qkit.set_license_label(UUID, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION qkit.set_license_label(UUID, TEXT) TO authenticated;
