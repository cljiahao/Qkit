...
GitHub Actions CI pipelines: `ci.yml` (typecheck, lint, test, build, e2e, db, mutation), `security.yml` (gitleaks secret scan, CodeQL, `pnpm audit`), and `tag-release.yml` (auto-tag patch releases on `main`).
